...
✅ From this folder (Crop_geniues/deployment/huggingface/crop_price_v2/):
...
4. Copy Files
   cp ../Crop_geniues/deployment/huggingface/crop_price_v2/* .
   cp -r ../Crop_geniues/deployment/huggingface/crop_price_v2/src .
   cp -r ../Crop_geniues/deployment/huggingface/crop_price_v2/production_model .
   cp -r ../Crop_geniues/deployment/huggingface/crop_price_v2/processed .
   cp -r ../Crop_geniues/deployment/huggingface/crop_price_v2/monthly_cache .
   cp ../Crop_geniues/deployment/huggingface/crop_price_v2/district_latlon.csv .
...
See: Crop_geniues/deployment/github/monthly-cache-update.yml
